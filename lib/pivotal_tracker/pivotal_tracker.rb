...
# class PivotalTracker::Story; end
# class PivotalTracker::Iteration; end
# class PivotalTracker::Project; end
# class PivotalTracker::Note; end

# require 'pivotal_tracker/extensions'
...
class PivotalTracker::PivotalTracker
  ...
  def project
    ...
    PivotalTracker::Project.parse(response)
  end
  
  def stories
    response = stories_resource.get
    ::PivotalTracker::Story.parse(response)
  end

  def activities
    response = activities_resource.get
    ::PivotalTracker::Activity.parse(response)
  end
  ...
  def activities_resource
    project_resource['/activities']
  end
